...
<body>
    ...
    <form action="receba.php" method="post">
        ...
        <input type="number" name="numPeso" id="numPeso" step="0.5" min="0" max="250" required> <br> <br>

        <label for="numAltura">Altura: </label> <br>
        <input type="number" name="numAltura" id="numAltura" step="0.1" min="50" max="250" required> <br> <br>  
