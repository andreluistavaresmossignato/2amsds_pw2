...
class Pedido {
    ...
    public function __construct(Cliente $cliente, Carrinho $carrinho) { // só digitar construct e dar o enter
    ...
    public function exibirDetalhes(): void {
        ...
        echo "------------------ \n";
        echo "Total da compra: R$ " . number_format($this->carrinho->getTotal(), 2, ',' , '.') . "\n";
        echo "------------------ \n";
